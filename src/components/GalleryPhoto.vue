<template>
  <div class="modal z-20 h-screen w-full fixed left-0 top-0 flex justify-center items-center bg-black bg-opacity-70">
            <div class="bg-white rounded shadow-lg w-4/5 sm:w-1/3">
             ...
             <div class=" p-2 text-sm text-center"><span class="errors">*</span> means the field must be field</div>
                <div class="p-3">
                            ...
                            <label for="file-upload" class="cursor-pointer" >
                                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-yellow-600 border-dashed rounded-md">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        ...
                                        <input id="file-upload" @change="uploadGallery" name="file-upload" type="file" class="sr-only">
                                        </label>
                ...
                <button class="reg-log" @click="saveGallery"
                    v-if="!modal.id"
                 ...
                 <button v-else class="reg-log" @click="updateGallery(modal.id)"                   
                    v-bind:class="{ cursordisable: isLoading }"
                    :disabled="isLoading">
